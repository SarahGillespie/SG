...
```{r img_blog_post_Alg_Bias_3B_phantomplate, fig.cap="*Source: Phantomplate.com <br>Caption: Techniques used to obscure license plate numbers to avoid tickets from running red lights or routine tolls are adversarial input.*", echo=FALSE, out.width="50%"}
