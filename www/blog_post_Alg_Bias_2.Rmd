...
Biased data can create a biased algorithm in a two main ways. First, collecting data where the given information is simply incorrect and using that data to train a model.
