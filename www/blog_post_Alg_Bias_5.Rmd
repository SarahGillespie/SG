...
The code in this tuitorial is to predict the penguin species type from the Palmer Penguins package, but I tried to make it as generalized as possible for you to easily swap in your own data.
