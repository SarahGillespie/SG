...
* Trust score points must be independantly and identically distributed (i.i.d.).


### DIY

The code for the [To Trust Or Not To Trust A Classifier](https://arxiv.org/pdf/1805.11783.pdf) paper:  https://github.com/google/TrustScore
It appears there is a trsut scores package available for Python 3.